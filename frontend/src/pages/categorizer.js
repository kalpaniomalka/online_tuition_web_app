...
submit = (files) => {
  ...
  axios.post('http://localhost:3001/upload/doc', formData, config).then((response)=> {
    console.log("Video Uploaded Correctly")
    if(response.data == "success")
      currentComponent.setState({msg:"Document uploaded successfully!"})
    ...
    return (
        <div className="btn_style">
                    ...
                    <MDBCol>
                        <SectionContainer noBorder header=''>
                            <MDBJumbotron className='text-center'>
                                <h2 className='h1 display-3'>Upload Documents</h2>
                                <p className='lead'>
            ...
            <Modal show={this.state.modelShow}>
                            <Modal.Header className="model_hdr">Document Upload</Modal.Header>
                            <Modal.Body>
